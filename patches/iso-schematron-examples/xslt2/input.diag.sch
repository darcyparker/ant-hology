...
<iso:schema xmlns="http://purl.oclc.org/dsdl/schematron"
  ...
  >
  <!--Example based on http://www.dpawson.co.uk/schematron/diagnostics.html#diag.ex2 -->
  ...
  <iso:pattern id="chapter.checks">
    ...
    <iso:rule context="chapter">
      ...
      <iso:assert test="count(para) >= 1">Chapters must have more than 1 paragraph</iso:assert>
      ...
      <iso:assert test="desc" diagnostics="desc.diag">Descriptor</iso:assert>
    </iso:rule>
  </iso:pattern>


  <iso:diagnostics>
    <iso:diagnostic id="desc.diag">Descriptor missing from chapter <iso:value-of select="@id"/></iso:diagnostic>
  </iso:diagnostics>
</iso:schema>
